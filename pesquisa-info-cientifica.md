...
**Título da Playlist:** Pesquisa de Informação Científica para Doutoramento | Curso Completo (2025)

**Descrição da Playlist:**
🎓 Curso completo de Pesquisa de Informação Científica para estudantes de doutoramento, mestrado e investigadores. Baseado no webinar das Bibliotecas UA (2025/2026).

📌 **O que vais aprender:**
- O que é informação científica e como se certifica (peer review)
- Tipologias de documentos: artigos, revisões, literatura cinzenta
- Fontes de informação: b-on, RCAAP, Google Scholar, Scopus, WoS
- Método CRAAP para avaliação crítica de fontes
- Identificar e evitar revistas predatórias
- Estratégias de pesquisa com operadores booleanos
- Leitura e análise de artigos com o método IMRD
- Ferramentas IA: Elicit, Scispace, Consensus, Research Rabbit
- IA Generativa: ética, alucinações e boas práticas
...
**Hashtags:** #PesquisaCientífica #Doutoramento #BibliotecasUA #InformaçãoCientífica #MetodoCRAAP #IMRD #FerramentasIA #CompetenciasDeInformacao
...
**Tags:** informação científica, peer review, revisão por pares, ciência aberta, acesso aberto, método científico, conhecimento científico, bibliotecas UA, doutoramento, investigação científica, academic research, scientific method, open science

**Hashtags:** #InformaçãoCientífica #PeerReview #CiênciaAberta #Doutoramento #RevisãoPorPares
...
**Tags:** artigos científicos, artigos de revisão, literatura cinzenta, grey literature, conferências científicas, tipologias documentais, IMRD, doutoramento, bibliotecas UA, academic papers, review articles, grey literature, scientific documents

**Hashtags:** #ArtigosCientíficos #LiteraturaCinzenta #DocumentosCientíficos #Investigação #Doutoramento
...
**Tags:** b-on, RCAAP, Google Scholar, Scopus, Web of Science, bases de dados científicas, fontes de informação, pesquisa académica, bibliotecas UA, academic databases, scientific databases, research sources

**Hashtags:** #GoogleScholar #Scopus #FontesCientíficas #PesquisaAcadémica #Bon #RCAAP
...
**Tags:** método CRAAP, avaliação de informação, currency, relevance, authority, accuracy, purpose, fontes científicas, pensamento crítico, bibliotecas UA, CRAAP method, information evaluation, critical thinking

**Hashtags:** #MetodoCRAAP #AvaliaçãoDeFontes #PensamentoCrítico #Investigação #Doutoramento
...
**Tags:** revistas predatórias, predatory journals, integridade científica, DOAJ, Cabells, Think Check Submit, ética na publicação, bibliotecas UA, predatory publishing, academic integrity, publication ethics

**Hashtags:** #RevistasPredatórias #IntegridadeCientífica #PredatoryJournals #ÉticaAcadémica #DOAJ
...
**Tags:** operadores booleanos, boolean operators, AND OR NOT, estratégias de pesquisa, keywords, truncatura, tesauros, MeSH, pesquisa científica, bibliotecas UA, search strategies, research skills

**Hashtags:** #OperadoresBooleanos #EstratégiasDePesquisa #Keywords #PesquisaCientífica #Doutoramento
...
**Tags:** IMRD, estrutura de artigos, leitura científica, skimming, análise de artigos, introduction methods results discussion, leitura académica, bibliotecas UA, academic reading, article structure

**Hashtags:** #IMRD #LeituraCientífica #ArtigosCientíficos #Skimming #Doutoramento
...
**Tags:** Elicit, Scispace, Consensus, Research Rabbit, ferramentas IA, inteligência artificial, revisão de literatura, literature review, Semantic Scholar, OpenAlex, bibliotecas UA, AI research tools, academic AI

**Hashtags:** #Elicit #Scispace #FerramentasIA #InvestigaçãoCientífica #RevisãoDeLiteratura #Consensus
...
**Tags:** IA generativa, ChatGPT, alucinações IA, ética IA, AI hallucinations, inteligência artificial, verificação de fontes, privacidade dados, ética académica, bibliotecas UA, generative AI, academic AI ethics

**Hashtags:** #IAGenerativa #ChatGPT #AlucinaçõesIA #ÉticaIA #InvestigaçãoAcadémica
...
**Hashtags:** #Conclusão #BibliotecasUA #RecursosDeApoio #Investigação #Doutoramento #ReferencialUA
